...
(function () {
  ...
  var CSS = ''
    ...
    + 'color:#e05a5a;margin:14px 0 6px;padding-top:10px;border-top:1px solid var(--line)}'
    ...
    + 'border:1px solid var(--line);border-radius:9px;font:inherit;font-size:12.5px;background:var(--soft);color:var(--ink);'
    ...
    + '#aaPanel button{padding:7px 11px;border-radius:9px;border:1px solid var(--line);background:var(--panel);'
    + 'color:var(--ink);font:inherit;font-size:12px;font-weight:600;cursor:pointer;margin:0 5px 5px 0;'
