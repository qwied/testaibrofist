...
(function () {
  ...
  var D = {
    ...
    skinSub: "Every part is free. Your look is saved to “My skins”.",
    avatarSub: "Dress up your character, buy items for coins and save your looks.",
    tabWear: "Outfits",
    ...
    publishSkin: "Add to Ready skins",
    ...
    avatarEmpty: "The developer has not picked any skins yet.",
    skinBy: "Skin",
    ...
    waitTitle: "Waiting for players",
    waitText: "Roles will be picked in 30 seconds.",
    hsWaitText: "Need at least one more player to start the round.",
    ...
    gameCoinTip: "coins on the map (max 3)",
    edTimeTip: "run time",
    edCoinTip: "coins collected",
    ...
    btnGridTip: "Grid (G)",
    btnPlayTip: "Play",
    coinLimitTitle: "Max {n} coins",
    coinLimitBody: "You can't add more coins to the map.",
    ...
    finishTitle: "FINISH!",
    finishBody: "Time {t}s · coins {c}/{ct} · deaths {d}   —   new run starting shortly",
    ...
    tooManyCoinsTitle: "Too many coins",
    tooManyCoinsBody: "The map has {n}. Allowed no more than {lim} — remove extras.",
