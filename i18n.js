...
(function () {
  ...
  var D = {
    ...
    chkZombie: "Zombie (chases)",
    zombieHint: "Only works with the Zombie Apocalypse modifier. In the classic version of the map this shape is not there.",
    modClassic: "Classic",
  ...
  var RU = {
    ...
    chkZombie: "Зомби (преследует)",
    zombieHint: "Работает только при модификации Zombie Apocalypse. В классическом варианте карты этой фигуры нет.",
    modClassic: "Классика",
    modApoc: "Zombie Apocalypse",
    grpLinks: "Связи",
    lblTargets: "Цели",
