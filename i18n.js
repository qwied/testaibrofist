...
(function () {
  ...
  var D = {
    ...
    skinBodyHint: "The greyed-out silhouette just shows where the head and body land — you can draw on it too, not only around it.",
    skinMarginHint: "There's room above, left and right of the head for tall hats, ears, wide shoulders and the like.",
    skinMirrorHint: "Left/right mirror is on by default — turn it off with the ⇋ button.",
    skinKeysHint: "Shortcuts: B/L/R/G/E/I for tools, [ ] for brush size, Ctrl+Z / Ctrl+Shift+Z to undo/redo.",
    ...
    skinBrushSize: "Brush size",
    skinUndo: "Undo",
    skinRedo: "Redo",
    skinToolBrush: "Brush",
    skinToolLine: "Line",
    skinToolRect: "Rectangle",
