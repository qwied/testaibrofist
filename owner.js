...
(function () {
  ...
  var css = ''
    ...
    + 'background:var(--panel);border:3px solid var(--line);border-radius:10px;padding:22px 24px 18px;z-index:9999;'
    ...
    + 'padding:3px 8px;color:red;background:var(--panel);cursor:pointer;line-height:1}'
    + '.ow-h{text-align:center;font-size:16px;color:var(--muted);margin:2px 0 10px}'
    + '.ow-sub{font-size:13px;font-weight:bold;color:var(--ink);margin:14px 0 6px;'
    ...
    + 'margin:7px 0;display:block;width:100%;background:var(--panel);color:#2196F3;cursor:pointer}'
    ...
    + 'cursor:pointer;margin-left:5px;background:var(--panel);white-space:nowrap}'
    ...
    + 'font-size:11.5px;cursor:pointer;background:var(--panel);white-space:nowrap}'
