...
/* 4 квеста в сутки + бонус за выполнение всех разом. Прогресс копится
   ...
   вместе с уровнем, а награда — 10, 18 или 30 монет. Уровни раздаются
...
/* Уровни: mul умножает базовую цель задания, reward — плата за него.
   Крайние значения (10 и 30) заданы явно как нижняя и верхняя граница. */
const TIERS = {
  easy:   { mul: 1, reward: 10 },
  medium: { mul: 2, reward: 18 },
  hard:   { mul: 3, reward: 30 }
};
