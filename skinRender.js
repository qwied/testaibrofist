...
(function () {
  ...
  function svg(skin, byId, opt) {
    ...
    /* Рисунок из Skin Editor поверх силуэта — можно закрасить и голову
       с телом (тогда игровой цвет роли под ними не виден), не только
       аксессуары вокруг. Встраиваем в тот же SVG, чтобы рисунок никогда
       не съезжал относительно фигуры при любой высоте/обрезке карточки.
